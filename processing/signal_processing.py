...
class STFT_module(nn.Module):
    def __init__(self, n_fft, hop_length, win_length, center=True, normalized=False, window=torch.hann_window,
                 mode='real_imag', device='cpu'):
...
class iSTFT_module_1_8(nn.Module):
    ...
    def __init__(self, n_fft, hop_length, win_length, length, center=False, window=None, mode='real_imag',
                 device='cpu'):
...
if __name__ == '__main__':
    ...
    spec = STFT_module(n_fft=1200, hop_length=600, win_length=1200, center=True, normalized=False,
                       window=torch.hann_window, )(a)
